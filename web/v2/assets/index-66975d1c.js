...
(function(exports) {
  ...
  function G2(a) {
    for (var b = h2(t3); null !== b; ) {
      if (null === b.callback)
        k2(t3);
      else if (b.startTime <= a)
        k2(t3), b.sortIndex = b.expirationTime, f2(r2, b);
      else
        break;
      b = h2(t3);
    }
  ...
  exports.unstable_scheduleCallback = function(a, b, c) {
    ...
    c > d ? (a.sortIndex = c, f2(t3, a), null === h2(r2) && a === h2(t3) && (B2 ? (E2(L2), L2 = -1) : B2 = true, K2(H2, c - d))) : (a.sortIndex = e2, f2(r2, a), A2 || z2 || (A2 = true, I2(J2)));
    return a;
  };
  ...
  Jb(function() {
    ...
    a: {
      ...
      if (void 0 !== h3) {
        ...
        var t3 = 0 !== (b & 4), J2 = !t3 && "scroll" === a, x2 = t3 ? null !== h3 ? h3 + "Capture" : null : h3;
        t3 = [];
        ...
        0 < t3.length && (h3 = new k3(h3, n2, null, c, e3), g2.push({ event: h3, listeners: t3 }));
      }
    }
    if (0 === (b & 7)) {
      a: {
        ...
        if (k3 || h3) {
          ...
          if (k3 !== n2) {
            ...
            J2 = null == k3 ? h3 : ue(k3);
            u2 = null == n2 ? h3 : ue(n2);
            h3 = new t3(F2, w2 + "leave", k3, c, e3);
            h3.target = J2;
            h3.relatedTarget = u2;
            F2 = null;
            Wc(e3) === d2 && (t3 = new t3(x2, w2 + "enter", n2, c, e3), t3.target = u2, t3.relatedTarget = J2, F2 = t3);
            J2 = F2;
            if (k3 && n2)
              b: {
                t3 = k3;
...
function vh(a) {
  ...
  function t3(e3, g2, h3, k3) {
    ...
    for (var u2 = l3 = null, m3 = g2, w2 = g2 = 0, x2 = null, n3 = h3.next(); null !== m3 && !n3.done; w2++, n3 = h3.next()) {
      ...
      a && m3 && null === t4.alternate && b(e3, m3);
      g2 = f2(t4, g2, w2);
        ...
        try {
          ...
          if (0 !== (b.flags & 1024))
            switch (b.tag) {
              ...
              case 1:
                if (null !== n2) {
                  var t3 = n2.memoizedProps, J2 = n2.memoizedState, x2 = b.stateNode, w2 = x2.getSnapshotBeforeUpdate(b.elementType === b.type ? t3 : Lg(b.type, t3), J2);
...
const createStoreImpl = (createState) => {
  ...
  const destroy = () => {
    if (({ "VITE_REACT_APP_WEBSOCKET_BASE_URL": "https://talk.cygnus.press/socket.io/", "BASE_URL": "./", "MODE": "production", "DEV": false, "PROD": true, "SSR": false } ? "production" : void 0) !== "production") {
      console.warn(
...
var k = "function" === typeof Object.is ? Object.is : h$1, l = e$2.useState, m = e$2.useEffect, n$1 = e$2.useLayoutEffect, p$1 = e$2.useDebugValue;
function q$1(a, b) {
...
var u$1 = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? t$3 : q$1;
...
var q = "function" === typeof Object.is ? Object.is : p, r$1 = n.useSyncExternalStore, t$2 = h.useRef, u = h.useEffect, v = h.useMemo, w = h.useDebugValue;
...
function useStore(api, selector = api.getState, equalityFn) {
  if (({ "VITE_REACT_APP_WEBSOCKET_BASE_URL": "https://talk.cygnus.press/socket.io/", "BASE_URL": "./", "MODE": "production", "DEV": false, "PROD": true, "SSR": false } ? "production" : void 0) !== "production" && equalityFn && !didWarnAboutEqualityFn) {
    console.warn(
...
const createImpl = (createState) => {
  if (({ "VITE_REACT_APP_WEBSOCKET_BASE_URL": "https://talk.cygnus.press/socket.io/", "BASE_URL": "./", "MODE": "production", "DEV": false, "PROD": true, "SSR": false } ? "production" : void 0) !== "production" && typeof createState !== "function") {
    console.warn(
...
function e$1(e2, t3, s3, i2) {
  return new (s3 || (s3 = Promise))(function(r2, n2) {
    function o(e3) {
      try {
        c(i2.next(e3));
      } catch (e4) {
    ...
    function c(e3) {
      var t4;
      e3.done ? r2(e3.value) : (t4 = e3.value, t4 instanceof s3 ? t4 : new s3(function(e4) {
        e4(t4);
      })).then(o, a);
    }
    c((i2 = i2.apply(e2, t3 || [])).next());
  });
}
...
const i$1 = ["audio/webm", "audio/wav", "audio/mpeg", "audio/mp4", "audio/mp3"];
class r extends s$1 {
  constructor() {
  ...
  renderMicStream(e2) {
    ...
    s3.connect(i2);
    const r2 = i2.frequencyBinCount, n2 = new Float32Array(r2), o = r2 / t3.sampleRate;
    let a;
    const c = () => {
      i2.getFloatTimeDomainData(n2), this.wavesurfer && (this.wavesurfer.options.cursorWidth = 0, this.wavesurfer.options.interact = false, this.wavesurfer.load("", [n2], o)), a = requestAnimationFrame(c);
    };
    return c(), () => {
      cancelAnimationFrame(a), null == s3 || s3.disconnect(), null == t3 || t3.close();
    };
  }
  startMic() {
  ...
  startRecording() {
    return e$1(this, void 0, void 0, function* () {
      const e2 = this.stream || (yield this.startMic()), t3 = this.mediaRecorder || new MediaRecorder(e2, { mimeType: this.options.mimeType || i$1.find((e3) => MediaRecorder.isTypeSupported(e3)), audioBitsPerSecond: this.options.audioBitsPerSecond });
...
const Recorder = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 justify-center items-center " + (isRecording ? "hidden" : ""), children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "prose text-slate-500", children: [
            "Hold ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("kbd", { className: "border rounded-md bg-white px-1.5 py-0.5", children: "Spacebar" }),
            " to speak"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { hidden: !isRecording, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "svg",
          {
            xmlns: "http://www.w3.org/2000/svg",
            viewBox: "0 0 24 24",
...
const devtoolsImpl = (fn, devtoolsOptions = {}) => (set2, get2, api) => {
  ...
  try {
    extensionConnector = (enabled != null ? enabled : ({ "VITE_REACT_APP_WEBSOCKET_BASE_URL": "https://talk.cygnus.press/socket.io/", "BASE_URL": "./", "MODE": "production", "DEV": false, "PROD": true, "SSR": false } ? "production" : void 0) !== "production") && window.__REDUX_DEVTOOLS_EXTENSION__;
  } catch (e2) {
  }
  if (!extensionConnector) {
    if (({ "VITE_REACT_APP_WEBSOCKET_BASE_URL": "https://talk.cygnus.press/socket.io/", "BASE_URL": "./", "MODE": "production", "DEV": false, "PROD": true, "SSR": false } ? "production" : void 0) !== "production" && enabled) {
      console.warn(
  ...
  if (api.dispatchFromDevtools && typeof api.dispatch === "function") {
    ...
    api.dispatch = (...a) => {
      if (({ "VITE_REACT_APP_WEBSOCKET_BASE_URL": "https://talk.cygnus.press/socket.io/", "BASE_URL": "./", "MODE": "production", "DEV": false, "PROD": true, "SSR": false } ? "production" : void 0) !== "production" && a[0].type === "__setState" && !didWarnAboutReservedActionType) {
        console.warn(
...
const useConvStore = create()(
  devtools(
    persist((set2) => ({
      ...
      replaceQueAns: (queAns) => set2((state) => ({
...
class i extends e {
  constructor(t3) {
    super(t3 || {}), this.unsubscribe = () => {
      ...
      if (!this.wavesurfer)
        return;
      const e2 = this.wavesurfer.getWrapper().getBoundingClientRect(), { width: s3 } = e2, i2 = t4.clientX - e2.left, r2 = Math.min(1, Math.max(0, i2 / s3)), n2 = Math.min(s3 - this.options.lineWidth - 1, i2);
      this.wrapper.style.transform = `translateX(${n2}px)`, this.wrapper.style.opacity = "1";
      const o = this.wavesurfer.getDuration() || 0;
      this.label.textContent = this.formatTime(o * r2);
      const a = this.label.offsetWidth;
      this.label.style.transform = n2 + a > s3 ? `translateX(-${a + this.options.lineWidth}px)` : "", this.emit("hover", r2);
    }, this.onPointerLeave = () => {
...
const Audio = ({ audio, self }) => {
  ...
  reactExports.useEffect(() => {
    ...
    if (audio.status === "done") {
      getBlob(audio.audioBlobKey).then((r2) => {
        if (r2) {
        ...
        console.error("failed to get audio blob", audio.audioBlobKey, e2);
      });
    }
  }, [audio]);
  if (!audio) {
  ...
  switch (audio.status) {
    ...
    case "done":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(Wave, { url: audioUrl, audioIndex: audio.audioBlobKey, self });
    case "error":
...
const Wave = ({ url, audioIndex, self }) => {
    ...
    case "done":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: text.content })
        }
      );
    case "error":
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
...
const MessageList = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-auto w-full max-w-2xl", ref: scrollRef, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-5 rounded-lg w-full justify-end max-w-2xl", children: qaSlice.map(
    (qa2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2 mr-2", id: "message-list", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SelfText, { text: qa2.que.text }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(AssistantText, { text: qa2.ans.text }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg text-neutral-900 w-1/2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Audio, { audio: qa2.ans.audio, self: false }) })
    ] }, qa2.id)
  ) }) });
};
const sendMessage = (socket, event) => {
...
const historyMessages = (qaSlice, maxHistoryMessage) => {
  let messages = [];
  qaSlice.map((qa2) => qa2.que.text).filter((t3) => t3.status == "done").forEach((t3) => messages.push({ role: "user", content: t3.content }));
  qaSlice.map((qa2) => qa2.ans.text).filter((t3) => t3.status == "done").forEach((t3) => messages.push({ role: "assistant", content: t3.content }));
  messages = messages.slice(-maxHistoryMessage);
  return messages;
};
function currentSocketProtocolHostPort() {
...
const TextArea = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center w-full mt-auto bottom-0 max-w-2xl backdrop-blur bg-opacity-75", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        className: "rounded-full bg-slate-200 flex items-center justify-center w-10 -mb-1 " + (isRecording ? "hidden" : ""),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex w-full max-w-2xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "textarea",
        {
          className: "w-full outline-0 rounded-lg resize-none bg-slate-200 pl-2 py-1 mt-auto " + (isRecording ? "hidden" : ""),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "flex flex-col justify-center items-center w-full outline-0 rounded-lg h-20 resize-none bg-slate-200 py-1 mt-auto " + (isRecording ? "" : "hidden"),
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "prose text-lg text-slate-800", children: timeElapsedMMSS(recordDuration) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center w-full", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1/2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end mr-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "prose text-slate-500 bg-white rounded-full px-2", children: [
                "Release to ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline text-blue-500", children: "send" })
              ] }) }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1/2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex ml-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "prose text-slate-500 bg-white rounded-full px-2", children: [
                "Press any key to ",
...
const outEventTypeAudio = "audio";
const outEventTypeConversation = "conversation";
const inEventTypeAudio = "audio";
const inEventTypeMessage = "message";
const inEventTypeTranscription = "transcription";
const useSocketEvensStore = create()((set2, get2) => ({
  inMessages: [],
  pushInMessage: (e2) => set2((state) => ({
    ...state,
    inMessages: [...state.inMessages, e2]
  })),
  popInMessage: () => {
    const [first, ...rest] = get2().inMessages;
    set2((state) => ({ ...state, inMessages: rest }));
    return first;
  },
  inAudios: [],
  pushInAudio: (e2) => set2((state) => ({
    ...state,
    inAudios: [...state.inAudios, e2]
  })),
  popInAudio: () => {
    const [first, ...rest] = get2().inAudios;
    set2((state) => ({ ...state, inAudios: rest }));
    return first;
  },
  inTranscriptions: [],
  pushInTranscription: (e2) => set2((state) => ({
    ...state,
    inTranscriptions: [...state.inTranscriptions, e2]
  })),
  popInTranscription: () => {
    const [first, ...rest] = get2().inTranscriptions;
    set2((state) => ({ ...state, inTranscriptions: rest }));
    return first;
  }
}));
/*! *****************************************************************************
...
function __values(o) {
  var m2 = typeof Symbol === "function" && o[Symbol.iterator], i2 = 0;
  if (m2)
    return m2.call(o);
  return {
    next: function() {
...
const useSocketStore = create(() => ({ socket: new ReconnectingWebSocket(socketEndpoint()) }));
console.info("websocket base url", "https://talk.cygnus.press/socket.io/");
const Websocket = () => {
...
const newMyText = (queText) => {
  return { content: queText ?? "", status: "pending" };
};
const onNewContent = (t3, newContent, eof) => {
  switch (t3.status) {
    case "pending":
    case "receiving":
      return {
        ...t3,
        content: t3.content + newContent,
        contentLastUpdatedAt: formatISO(/* @__PURE__ */ new Date()),
        status: eof ? "done" : "receiving"
      };
    case "half-done":
      console.warn("bad state: updating a half-done text", t3.content, newContent);
      return { ...t3 };
    case "done":
...
const SubscribeInMessage = () => {
  ...
  reactExports.useEffect(
    () => {
      ...
      const qasMatched = qaSlice.filter((q2) => q2.id === inMsg.id);
      ...
      const qa2 = qasMatched[0];
      const text = qa2.ans.text;
      const newText = inMsg.err ? onError$1(text, inMsg.err) : onNewContent(text, inMsg.content, inMsg.eof);
      const newQa = {
        ...qa2,
        ans: {
          ...qa2.ans,
...
const onNewAudioBlobId = (a, audioBlobKey) => {
  switch (a.status) {
    case "pending":
      if (!audioBlobKey) {
...
const SubscribeInAudio = () => {
  ...
  reactExports.useEffect(
    () => {
      ...
      const qasMatched = qaSlice.filter((q2) => q2.id === inAudio.id);
      if (qasMatched.length === 0) {
      ...
      const qa2 = qasMatched[0];
      const audio = qa2.ans.audio;
      if (inAudio.err === "") {
        const blob = base64ToBlob(inAudio.audio, inAudio.format);
        const id2 = v4();
        addBlob({ id: id2, blob }).then(() => {
          console.debug("saved audio blob", id2);
          const newAudio2 = onNewAudioBlobId(audio, id2);
          const newQa = {
            ...qa2,
            ans: {
              ...qa2.ans,
          ...
          console.error("failed to save audio blob", id2, e2);
        });
      } else {
        const newAudio2 = onError(audio, inAudio.err);
        const newQa = {
          ...qa2,
          ans: {
            ...qa2.ans,
...
const SubscribeInTranscription = () => {
  const qaSlice = useConvStore((state) => state.qaSlice);
  const replaceQueAns = useConvStore((state) => state.replaceQueAns);
  ...
  reactExports.useEffect(
    () => {
      ...
      const qasMatched = qaSlice.filter((q2) => q2.id === inTan.id);
      if (qasMatched.length === 0) {
      ...
      const qa2 = qasMatched[0];
      const text = qa2.que.text;
      const newText = inTan.err ? onError$1(text, inTan.err) : onNewContent(text, inTan.text, inTan.eof);
      const newQa = {
        ...qa2,
        que: {
          ...qa2.que,
...
const newQueAns = (id2, questionHasAudio, queText) => {
  return {
    id: id2,
    que: {
      text: newMyText(queText),
      audio: questionHasAudio ? newAudio() : void 0
    },
    ans: {
      text: newMyText(queText),
      audio: newAudio()
...
const SubscribeSendingAudio = () => {
  ...
  reactExports.useEffect(() => {
    ...
    blobToBase64(sendingAudio).then((r2) => {
      const event = {
        id: id2,
    ...
    addBlob({ id: id2, blob: sendingAudio }).then(() => {
      console.debug("saved audio blob", id2);
      const qa2 = newQueAns(id2, true);
      qa2.que.audio.audioBlobKey = id2;
      qa2.que.audio.status = "done";
      qa2.que.text.status = "pending";
      pushQueAns(qa2);
    }).catch((e2) => {
      console.error("failed to save audio blob", id2, e2);
    });
...
const TextSubscriber = () => {
  ...
  reactExports.useEffect(() => {
    ...
    sendMessage(socket, event);
    const qa2 = newQueAns(id2, false);
    qa2.que.text.content = sendingText;
    qa2.que.text.status = "done";
    pushQueAns(qa2);
  }, [sendingText]);
  return null;
};
const Subscribers = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SubscribeInMessage, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SubscribeInAudio, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SubscribeInTranscription, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(TextSubscriber, {}),
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-between h-screen w-screen gap-1 p-1 overflow-hidden", id: "container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(MessageList, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center w-full mt-auto bottom-0 max-w-2xl backdrop-blur bg-opacity-75", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Websocket, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Subscribers, {})
  ] });
}
