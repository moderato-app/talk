...
const devtoolsImpl = (fn, devtoolsOptions = {}) => (set2, get2, api) => {
  ...
  if (api.dispatchFromDevtools && typeof api.dispatch === "function") {
    ...
    api.dispatch = (...a) => {
      if (({ "BASE_URL": "./", "MODE": "production", "DEV": false, "PROD": true, "SSR": false } ? "production" : void 0) !== "production" && a[0].type === "__setState" && !didWarnAboutReservedActionType) {
        console.warn(
...
console.info("websocket base url", {}.VITE_REACT_APP_WEBSOCKET_BASE_URL);
const Websocket = () => {
